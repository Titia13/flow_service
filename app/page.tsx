...
function LoginForm() {
  ...
  const { UserLogin, isAuthenticated, error, loading } = useUserStore()
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100" style={{ backgroundColor: '#fffaf7' }}>
      <div className="relative z-20 flex min-h-screen items-center justify-center px-4 py-8">
        <div className="w-full max-w-5xl rounded-3xl bg-white shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="hidden md:flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 p-12">
              <div className="text-center">
                <img src={auth} alt="Auth illustration" className="w-72 mx-auto mb-6" />
                <h2 className="text-3xl font-bold text-white mb-3">Bienvenue sur Flow</h2>
                <p className="text-indigo-100">Connectez-vous pour accéder à votre espace</p>
              </div>
            </div>
            ...
            <div className="p-12 flex flex-col justify-center">
              ...
              >
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white mt-4 py-6"
                >
