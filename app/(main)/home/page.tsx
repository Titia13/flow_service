  ...
  return (
    <main className="min-h-screen flex flex-col items-center">
      ...
      <section className="px-6 py-10">
        <Link
          href="/application"
          className="group inline-flex items-center gap-3 text-slate-700 text-lg font-medium bg-slate-100 hover:bg-orange-500 hover:text-white px-6 py-2 rounded-full transition-all duration-300"
        >
          C&apos;est parti !!!
